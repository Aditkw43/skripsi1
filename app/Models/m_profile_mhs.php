...
class m_profile_mhs extends Model
{
    protected $table = 'profile_mhs';
    protected $primaryKey = 'id_profile_mhs';
    protected $allowedFields = ['nim', 'fakultas', 'jurusan', 'prodi', 'semester', 'madif', 'pendamping'];
    ...
    public function getApprovalSkill()
    {
    }

    public function getApprovalJenisMadif()
    {
    }
    ...
    public function reject_jenis_madif()
    {
    }
