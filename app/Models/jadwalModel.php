...
class jadwalModel extends Model
{
    ...
    protected $allowedFields = ['nim_jadwal', 'mata_kuliah', 'tanggal_ujian', 'waktu_mulai_ujian', 'waktu_selesai_ujian', 'ruangan', 'keterangan'];

    public function getJadwalUjian($nim = 0)
    {
        if ($nim == 0) {
            return $this->findAll();
        }

        return $this->where(['nim_jadwal' => $nim])->findAll();
    }
