                            ...
                            <tbody class="table-light">
                                ...
                                <?php foreach ($pendamping as $pd) : ?>
                                    <tr class="align-middle">
                                        ...
                                        <td><?= $pd['semester']; ?></td>
                                        <td>
                                            <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#edit<?= $pd['id_profile_mhs']; ?>" ?>
                                                Edit
                                            </button>
                                            <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#edit<?= $pd['id_profile_mhs']; ?>" ?>
                                                Hapus
                                            </button>
                                        </td>
                                    </tr>
